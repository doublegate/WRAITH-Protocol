  ...
  const handleSaveSettings = async () => {
    ...
    try {
      const updated = await updateGroupSettings(
        ...
        editDescription !== (groupInfo.description || "")
          ? editDescription
          : undefined,
      );
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                {groupInfo.am_i_admin && (
                  <button className="px-4 py-2 border border-slate-600 rounded hover:bg-slate-600 transition">
                    Change Avatar
                  </button>
                )}
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full p-3 bg-bg-primary border border-slate-600 rounded focus:border-wraith-primary focus:outline-none disabled:opacity-50"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  disabled={!groupInfo.am_i_admin}
                  rows={3}
                  className="w-full p-3 bg-bg-primary border border-slate-600 rounded focus:border-wraith-primary focus:outline-none resize-none disabled:opacity-50"
                />
              </div>
                ...
                <div className="p-4 bg-bg-primary rounded">
                  ...
                  <div className="space-y-3">
                    <input
                      ...
                      placeholder="Peer ID"
                      className="w-full p-2 bg-bg-secondary border border-slate-600 rounded focus:border-wraith-primary focus:outline-none font-mono text-sm"
                    />
                    <input
                      type="text"
                      value={newMemberName}
                      ...
                      className="w-full p-2 bg-bg-secondary border border-slate-600 rounded focus:border-wraith-primary focus:outline-none"
                    />
                    <button
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-full bg-slate-700 flex items-center justify-center">
                          {(member.display_name || member.peer_id)
                            .charAt(0)
                            .toUpperCase()}
                        </div>
                        <div>
                      ...
                      {groupInfo.am_i_admin && (
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            ...
                            className="px-3 py-1 text-sm border border-slate-600 rounded hover:bg-slate-600 transition"
                          >
                          ...
                          {memberToRemove === member.peer_id ? (
                            <div className="flex items-center gap-1">
                              <button
                                onClick={() =>
                                  handleRemoveMember(member.peer_id)
                                }
          ...
          {activeTab === "security" && (
            <div className="space-y-6">
              ...
              <div className="p-4 bg-bg-primary rounded">
                ...
                <p className="text-sm text-slate-400">
                  All messages in this group are encrypted using the Sender Keys
                  protocol. Each member has a unique encryption key that is
              ...
              {groupInfo.am_i_admin && (
                <div className="p-4 bg-bg-primary rounded">
                  ...
                  <p className="text-sm text-slate-400 mb-4">
                    Keys are automatically rotated every 7 days. You can
                    manually rotate keys if a member was removed or you suspect
                    key compromise.
                  </p>
                  <button
                    onClick={handleRotateKeys}
                    disabled={loading}
                    className="px-4 py-2 border border-slate-600 rounded hover:bg-slate-600 transition disabled:opacity-50"
                  >
              ...
              <div className="p-4 border border-red-500/50 rounded">
                ...
                <p className="text-sm text-slate-400 mb-4">
                  Once you leave this group, you will no longer receive messages
                  and your message history will be archived.
                </p>
                {confirmLeave ? (
                  <div className="flex items-center gap-2">
                    <button
                    ...
                    <button
                      ...
                      className="px-4 py-2 border border-slate-600 rounded hover:bg-slate-600 transition"
                    >
                      Cancel
                    </button>
                  </div>
    ...
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
      <div className="bg-bg-secondary w-full max-w-md p-6 rounded-lg">
        ...
        <input
          ...
          autoFocus
          className="w-full p-3 bg-bg-primary border border-slate-600 rounded focus:border-wraith-primary focus:outline-none mb-4"
        />
