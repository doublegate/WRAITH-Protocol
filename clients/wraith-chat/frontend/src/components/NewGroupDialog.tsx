...
export default function NewGroupDialog({ isOpen, onClose }: NewGroupDialogProps) {
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-2 px-6 py-3 border-b border-slate-700/50">
          <StepIndicator number={1} active={step === 'name'} completed={step === 'members'} label="Name" />
          <div className="flex-1 h-px bg-slate-700" />
          <StepIndicator number={2} active={step === 'members'} completed={false} label="Members" />
        </div>
                  ...
                  contacts.map((contact) => (
                    ...
                    >
                      ...
                      <div className="w-10 h-10 rounded-full bg-gradient-to-br from-wraith-primary to-wraith-secondary flex items-center justify-center text-sm font-semibold text-white">
                        {(contact.display_name || contact.peer_id)[0].toUpperCase()}
                      </div>
