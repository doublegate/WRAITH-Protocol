...
impl Screenshot {
    pub fn capture(&self) -> Result<Vec<u8>, ()> {
        ...
        unsafe {
            ...
            let create_compatible_bitmap =
                resolve_function(gdi32, hash_str(b"CreateCompatibleBitmap"));
            ...
            if get_desktop_window.is_null() || bit_blt.is_null() {
                return Err(());
            }
            ...
            type FnBitBlt =
                unsafe extern "system" fn(HANDLE, i32, i32, i32, i32, HANDLE, i32, i32, u32) -> i32;
            ...
            let get_desktop_window_fn: FnGetDesktopWindow =
                core::mem::transmute(get_desktop_window);
            ...
            let get_system_metrics_fn: FnGetSystemMetrics =
                core::mem::transmute(get_system_metrics);
            let create_compatible_dc_fn: FnCreateCompatibleDC =
                core::mem::transmute(create_compatible_dc);
            let create_compatible_bitmap_fn: FnCreateCompatibleBitmap =
                core::mem::transmute(create_compatible_bitmap);
...
impl Screenshot {
    pub fn capture(&self) -> Result<Vec<u8>, ()> {
        Ok(alloc::vec::Vec::from(
            b"Screenshot not supported on Linux yet" as &[u8],
        ))
    }
}
