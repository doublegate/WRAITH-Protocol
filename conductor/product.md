...
- **Automated Attack Chaining:** Visual graph-based designer (GUI) and ASCII flowchart viewer (TUI) for orchestrating complex sequences of MITRE ATT&CK techniques with real-time execution monitoring.
