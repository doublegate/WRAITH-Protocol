...
**Note:** Documentation expanded significantly for v2.0.0 with client applications and comprehensive development history. As of v2.3.2, all 12 client applications (9 desktop + 2 mobile + 1 server) are documented.
